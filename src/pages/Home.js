...
const Home = function () {
  ...
  <div>
    ...
    <main className="text-gray-900">
      ...
      <section id="features" className="py-0 lg:pb-40 lg:pt-48">
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    Discover the most frequently added tokens by users. Bitcoin (BTC) and Ethereum (ETH) lead the pack.
                    </p>
                    <p className="mt-8 md:mt-12">
                    <Link to={"/top10"}>
                  <button
                ...
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    Stay updated with the latest price gainers, biggest losers, and most searched cryptocurrencies.
                    </p>
                    <p className="mt-8 md:mt-12">
                    <Link to={"/trending"}>
                  <button
                ...
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    Add these top 10 cryptos to your watchlist and track their performance.
                    </p>
                    <p className="mt-8 md:mt-12">
                    <Link to={"/watchlist"}>
                  <button
      ...
      <section className="container mx-auto my-5 py-24 px-20 bg-gray-200 rounded-lg text-center">
        <h3 className="text-5xl font-semibold">Ready to grow your Portfolio?</h3>
        <p className="mt-8 text-xl font-light">
        Visit our website to explore cryptocurrencies, add your favorites to your watchlist, and invest wisely after thoroughly researching and studying the exchange rates for informed decisions.
        </p>
        <p className="mt-8">
          <Link to={"/trending"}><button
            type="button"
